...
const QRScanner = ({ onScan, onClose }) => {
  ...
  const isRunningRef = useRef(false); // ← AJOUTÉ
  ...
  useEffect(() => {
      ...
      try {
        ...
        await html5QrCode.start(
          ...
          (decodedText) => {
            ...
            isRunningRef.current = false; // ← AJOUTÉ
        ...
        isRunningRef.current = true; // ← AJOUTÉ
        setScanning(true);
      } catch (err) {
    ...
    return () => {
      // ← CORRIGÉ : Vérifier si le scanner est en cours avant d'arrêter
